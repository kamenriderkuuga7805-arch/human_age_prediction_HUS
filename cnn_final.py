...
MODEL_PATH  = "best_age_model.pth" # Sửa lại đường dẫn model theo thiết bị
FINAL_MODEL = "age_predictor_final.pth" # Sửa lại đường dẫn model theo thiết bị
...
def save_dashboard(history, epoch, es_counter, best_val_mae, lr):
    ...
    path = f"dashboard_ep{epoch:02d}.png"
